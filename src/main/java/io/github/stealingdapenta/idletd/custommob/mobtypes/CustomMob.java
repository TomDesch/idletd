...
public abstract class CustomMob {
  ...
  public Mob summon(Location location) {
    ...
    MobWrapper customMob = MobWrapper.builder().playerUUID(plot.getPlayerUUID()).location(location)
        ...
        .max_health(max_health).regeneration_per_second(regeneration_per_second)
        ...
        .knockback_resistance(knockback_resistance).sword_resistance(sword_resistance)
        .axe_resistance(axe_resistance).magic_resistance(magic_resistance)
        .arrow_resistance(arrow_resistance).trident_resistance(trident_resistance)
        .explosion_resistance(explosion_resistance).fire_resistance(fire_resistance)
        .poison_resistance(poison_resistance).critical_hit_resistance(critical_hit_resistance)
        .block_chance(block_chance).attack_power(attack_power).attack_range(attack_range)
        .attack_knockback(attack_knockback).attack_speed(attack_speed)
        .projectile_speed(projectile_speed).critical_hit_chance(critical_hit_chance)
        .critical_hit_damage_multiplier(critical_hit_damage_multiplier).build();
