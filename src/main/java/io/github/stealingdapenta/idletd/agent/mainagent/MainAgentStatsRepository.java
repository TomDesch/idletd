...
public class MainAgentStatsRepository {
    ...
    public void saveMainAgentStats(MainAgentStats mainAgentStats) {
        try (Connection connection = getDataSource().getConnection();
            ...
            statement.setDouble(6, mainAgentStats.getKnockbackResistance());
            statement.setDouble(7, mainAgentStats.getSwordResistance());
            statement.setDouble(8, mainAgentStats.getAxeResistance());
            statement.setDouble(9, mainAgentStats.getMagicResistance());
            statement.setDouble(10, mainAgentStats.getArrowResistance());
            statement.setDouble(11, mainAgentStats.getTridentResistance());
            statement.setDouble(12, mainAgentStats.getExplosionResistance());
            statement.setDouble(13, mainAgentStats.getFireResistance());
            statement.setDouble(14, mainAgentStats.getPoisonResistance());
            statement.setDouble(15, mainAgentStats.getCriticalHitResistance());
            statement.setDouble(16, mainAgentStats.getBlockChance());
            statement.setDouble(17, mainAgentStats.getAttackPower());
            statement.setDouble(18, mainAgentStats.getAttackRange());
            statement.setDouble(19, mainAgentStats.getAttackKnockback());
            statement.setDouble(20, mainAgentStats.getAttackSpeed());
            statement.setDouble(21, mainAgentStats.getProjectileSpeed());
            statement.setDouble(22, mainAgentStats.getCriticalHitChance());
            statement.setDouble(23, mainAgentStats.getCriticalHitDamageMultiplier());
    ...
    public void updateMainAgentStats(MainAgentStats mainAgentStats) {
        try (Connection connection = getDataSource().getConnection();
            ...
            statement.setDouble(5, mainAgentStats.getKnockbackResistance());
            ...
            statement.setLong(23, mainAgentStats.getAgentId());
